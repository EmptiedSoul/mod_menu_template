...
-(id)initWithTitle:(NSString *)title_ titleColor:(UIColor *)titleColor_ titleFont:(NSString *)titleFont_ status:(NSString*)status_ statusColor:(UIColor*)statusColor_ statusFont:(NSString*)statusFont_ credits:(NSString *)credits_ headerColor:(UIColor *)headerColor_ switchOffColor:(UIColor *)switchOffColor_ switchOnColor:(UIColor *)switchOnColor_ switchTitleFont:(NSString *)switchTitleFont_ switchTitleColor:(UIColor *)switchTitleColor_ infoButtonColor:(UIColor *)infoButtonColor_ maxVisibleSwitches:(int)maxVisibleSwitches_ menuWidth:(CGFloat )menuWidth_ menuIcon:(NSString *)menuIconBase64_ menuButton:(NSString *)menuButtonBase64_ isHidden:(BOOL)isHidden_ isActivatedByGesture:(BOOL)isActivatedByGesture_ numberOfTapsRequired:(NSInteger)numberOfTapsRequired_ numberOfTouchesRequired:(NSInteger)numberOfTouchesRequired_;
...
-(UIButton*)addSectionButton:(UIScrollView*)scrollView_ text:(NSString*)imgBase64_;
-(void)activateScrollView:(id)button_;
